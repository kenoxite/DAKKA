...
diag_log "DMORBAT: Earthquake: Initializing";
...
_firstSorting = true;
DMORBAT_earthquake = true;

sleep 1;

while { DMORBAT_earthquake } do {
    ...
    diag_log "DMORBAT: Earthquake: Earthquake ended";

    // Wait for the next earthquake
    // private _wait = 10;
    private _wait = 10 + (random 180);
    for [{private _i = 0}, {(_i < _wait) && DMORBAT_earthquake}, {_i = _i + 1}] do
    {
        sleep 1;
    };
};
...
diag_log "DMORBAT: Earthquake: End";