...
DAKKA_rain = [1, 2.8]; // average annual precipitation [min, max] -- should be roughly based on real stats, in inches
DAKKA_rainMonths = [5, 2]; // months where precipitation is at its highest -- you can either start from the beginning of the rainy months or the end, it'll be sorted later
...
DAKKA_fogBase = 13;  // base altitude (ASL) of fog (in meters). Range -5000..5000 -- this value should be based on the lowest elevation of the terrain
...
DAKKA_locations_Task2 = [
        ["Contested Areas",
            [
                [[2715.36,5247.06,0],105],
                [[12924.1,10035.1,0],10],
                [[3819.09,8895.8,0],30]
            ]
        ]
    ];
