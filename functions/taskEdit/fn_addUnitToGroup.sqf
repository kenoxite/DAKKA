...
params [["_enemy", true]];
// if (DMORBAT_debug) then { diag_log format ["DMORBAT: addUnitToGroup params: %1", _enemy] };
...
if (DMORBAT_debug) then { diag_log format ["DMORBAT: addUnitToGroup _unitClass: %1", _unitClass] };
...
if (DMORBAT_debug) then { diag_log format ["DMORBAT: addUnitToGroup _groupNumber: %1 _selectionPath: %2", _groupNumber, _selectionPath] };
