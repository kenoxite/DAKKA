...
// Example:
// _nonGarrisoned = [_pos, units _grp, -1, true, false, false, false] call DAKKA_fnc_occupyHouse;
...
diag_log format ["DAKKA: occupyHouse - %2 units of Group %1 are trying to occupy nearby buildings", group (_units select 0), count _units];
