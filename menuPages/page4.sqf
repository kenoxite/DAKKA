...
//Reset map things
// if (!isNil "DAKKA_EH_mapSingleClick") then { removeMissionEventHandler ["MapSingleClick", DAKKA_EH_mapSingleClick] }; 
...
[IDC_COMBO_FACTIONS, false] call DAKKA_fnc_updateFactionCombo;
_ctrl ctrlSetEventHandler ["LBSelChanged", '[IDC_COMBO_FACTIONS, _this select 1, false, true] call DAKKA_fnc_ComboFactions_selChanged;'];
...
_ctrl ctrlSetEventHandler ["TreeSelChanged", ' [_this select 1] call DAKKA_fnc_TreeFactionGroups_selChanged; '];

	// Buttons
	_ctrl = (_display displayCtrl IDC_BT_ADD_GROUP);
	_ctrl ctrlSetText "Add group to Enemy Groups";
	_ctrl ctrlSetEventHandler ["ButtonClick", '[] call DAKKA_fnc_addGroupToGroup; '];
...
_ctrl ctrlSetEventHandler ["TreeSelChanged", ' [_this select 1, IDC_TREE_FACTION_GROUPS, IDC_TREE_FACTION_UNITS] call DAKKA_fnc_TreeFactionUnits_selChanged; '];
	...
	_ctrl ctrlSetEventHandler ["ButtonClick", '[] call DAKKA_fnc_addUnitToGroup; '];
	_ctrl ctrlSetTooltip "Adds the unit to the selected enemy group";
	if (DAKKA_Task == 2) then {
...
_ctrl ctrlShow false;
	...
	[IDC_TREE_GRP1, 1] call DAKKA_fnc_updateCustomGroupsTreeList;
	_ctrl ctrlSetEventHandler ["TreeSelChanged", ' [IDC_TREE_GRP1, _this select 1, 1, true, [IDC_BT_1_GRP1, IDC_BT_2_GRP1, IDC_BT_3_GRP1]] call DAKKA_fnc_TreeCustomGroup_selChanged; '];
	_ctrl ctrlShow true;
		...
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP1, tvCurSel IDC_TREE_GRP1, 1, true, [IDC_BT_1_GRP1, IDC_BT_2_GRP1, IDC_BT_3_GRP1]] call DAKKA_fnc_removeFromGroup; '];
		...
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP1, tvCurSel IDC_TREE_GRP1, 1, true] spawn DAKKA_fnc_editUnitAttributes; '];
		...
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP1, tvCurSel IDC_TREE_GRP1, 1, true] spawn DAKKA_fnc_editUnitLoadout; '];
...
if (ctrlVisible IDC_GRP_TASK_GROUP2) then {
	...
	[IDC_TREE_GRP2, 2] call DAKKA_fnc_updateCustomGroupsTreeList;
	_ctrl ctrlSetEventHandler ["TreeSelChanged", ' [IDC_TREE_GRP2, _this select 1, 2, true, [IDC_BT_1_GRP2, IDC_BT_2_GRP2, IDC_BT_3_GRP2]] call DAKKA_fnc_TreeCustomGroup_selChanged; '];
	_ctrl ctrlShow true;
		...
		_ctrl ctrlSetText "Remove";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP2, tvCurSel IDC_TREE_GRP2, 2, true, [IDC_BT_1_GRP2, IDC_BT_2_GRP2, IDC_BT_3_GRP2]] call DAKKA_fnc_removeFromGroup; '];
		_ctrl ctrlSetTooltip "Removes the selected unit or group";
		_ctrl ctrlEnable false;
		...
		_ctrl ctrlSetText "Attributes";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP2, tvCurSel IDC_TREE_GRP2, 2, true] spawn DAKKA_fnc_editUnitAttributes; '];
		_ctrl ctrlSetTooltip "Modify the unit or group skill, probability of presence, etc.";
		_ctrl ctrlEnable false;
		...
		_ctrl ctrlSetText "Loadout";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP2, tvCurSel IDC_TREE_GRP2, 2, true] spawn DAKKA_fnc_editUnitLoadout; '];
		_ctrl ctrlSetTooltip "Edit the unit's loadout";
		_ctrl ctrlEnable false;
...
if (ctrlVisible IDC_GRP_TASK_GROUP3) then {
	...
	[IDC_TREE_GRP3, 3] call DAKKA_fnc_updateCustomGroupsTreeList;
	_ctrl ctrlSetEventHandler ["TreeSelChanged", ' [IDC_TREE_GRP3, _this select 1, 3, true, [IDC_BT_1_GRP3, IDC_BT_2_GRP3, IDC_BT_3_GRP3]] call DAKKA_fnc_TreeCustomGroup_selChanged; '];
	_ctrl ctrlShow true;
		...
		_ctrl ctrlSetText "Remove";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP3, tvCurSel IDC_TREE_GRP3, 3, true, [IDC_BT_1_GRP3, IDC_BT_2_GRP3, IDC_BT_3_GRP3]] call DAKKA_fnc_removeFromGroup; '];
		_ctrl ctrlSetTooltip "Removes the selected unit or group";
		_ctrl ctrlEnable false;
		...
		_ctrl ctrlSetText "Attributes";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP3, tvCurSel IDC_TREE_GRP3, 3, true] spawn DAKKA_fnc_editUnitAttributes; '];
		_ctrl ctrlSetTooltip "Modify the unit or group skill, probability of presence, etc.";
		_ctrl ctrlEnable false;
		...
		_ctrl ctrlSetText "Loadout";
		_ctrl ctrlSetEventHandler ["ButtonClick", ' [IDC_TREE_GRP3, tvCurSel IDC_TREE_GRP3, 3, true] spawn DAKKA_fnc_editUnitLoadout; '];
		_ctrl ctrlSetTooltip "Edit the unit's loadout";
		_ctrl ctrlEnable false;
